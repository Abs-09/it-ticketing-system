<x-app-layout>
    ...
    <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
        ...
        <div>
            ...
            <div class="pt-4">
                <form action="{{ route('attachments.store', $ticket) }}" method="POST" enctype= 'multipart/form-data'
                    class="flex gap-x-2">
                    @csrf
                    <div>
            ...
            <div class="mt-6 border border-gray-200 p-4 rounded-lg space-y-4 dark:border-neutral-700">
                ...
                <div class="hidden sm:grid sm:grid-cols-5">
                    ...
                    <div
                        class="col-end text-center text-xs font-medium text-gray-500 uppercase dark:text-neutral-500 ">
                    </div>
                </div>
